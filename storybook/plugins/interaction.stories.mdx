...
**Note**: Some plugins might require access to the diagramMaker instance inside their event listeners. To avoid circular references when initializing diagram maker for such plugins, use a wrapper object like below.
