// Remove overridden typings once Preact redux updates typings for newer typescript versions
// Pull Request: https://github.com/developit/preact-redux/pull/34
...
export interface InferableComponentEnhancerWithProps<TInjectedProps, TNeedsProps> {
    (
        component: ComponentConstructor<TNeedsProps & TInjectedProps, {}>
    ): ComponentConstructor<TNeedsProps, {}>
}
