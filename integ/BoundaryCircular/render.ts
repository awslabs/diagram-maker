...
import {
  ...
  createPotentialNode, createRectangularNode, createToolsPanel, updateActionInLogger
} from '../utils';
    ...
    'diagramMakerContainer',
    {
      ...
      renderCallbacks: {
        ...
        node: (node: DiagramMakerNode<{}>, container: HTMLElement) => {
          if (node.typeId === 'testId-normal' || node.typeId === 'testId-normalWithSize' ||
            node.typeId === 'testId-centered') {
